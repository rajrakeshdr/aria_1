...
import { Mail, Lock, User, Sparkles, Shield, Chrome, Github, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-[#0a0e1a] dark:via-[#0f1419] dark:to-[#0a0e1a] p-4">
      ...
      >
          ...
          <div className="p-8 space-y-6">
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                <input type="checkbox" className="w-4 h-4 mt-1 rounded border-muted-foreground/30" required />
        ...
        <p className="text-center text-xs text-muted-foreground mt-4">
          Demo Mode: Using simulated registration. In production, integrate Supabase Auth for real user management.
        </p>
      </motion.div>
    </div>
  );
